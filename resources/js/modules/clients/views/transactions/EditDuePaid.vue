  ...
  <div class="content-card">
    <div class="content-header">
      <div class="d-flex justify-content-between align-items-center w-100">
        <h3 class="fs-5 m-0 text-light">Edit Due Paid</h3>
        <router-link to="/clients/transactions/due-paid" class="btn btn-outline-light btn-sm ms-auto">
        ...
        <table class="table table-dark table-striped table-hover table-bordered align-middle">
          ...
          <tbody>
            ...
            <tr v-else>
              ...
              <td>
                <input type="number" 
                       class="form-control form-control-sm modal-input fw-bold text-danger" 
          ...
          <div class="row g-0 mb-3 align-items-center">
            ...
            <div class="col-sm-9">
              <div class="input-group">
                ...
                <input type="number" class="form-control modal-input fw-bold text-danger fs-5" v-model.number="paymentForm.amount" @input="handleAmountInput">
              </div>
            </div>
          </div>
...
const fetchTransaction = async () => {
  try {
    ...
    router.push('/clients/transactions/due-paid');
  }
};
