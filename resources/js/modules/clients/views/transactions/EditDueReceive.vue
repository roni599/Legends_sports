  ...
  <div class="content-card">
    <div class="content-header">
      <div class="d-flex justify-content-between align-items-center w-100">
        <h3 class="fs-5 m-0 text-light">Edit Due Receive</h3>
        <router-link to="/clients/transactions/due-receive" class="btn btn-outline-light btn-sm ms-auto">
        ...
        <table class="table table-dark table-striped table-hover table-bordered align-middle">
          ...
          <tbody>
            <tr v-if="!invoice">
              ...
              <td class="ps-0">-</td>
              <td class="text-capitalize">General Due Receive</td>
              <td>{{ transaction ? new Date(transaction.created_at).toLocaleDateString() : '-' }}</td>
              <td>-</td>
              <td>
                <input type="number" 
          ...
          <div class="row g-0 mb-3 align-items-center">
            ...
            <div class="col-sm-9">
              <div class="input-group">
                ...
                <input type="number" class="form-control modal-input fw-bold text-success fs-5" v-model.number="paymentForm.amount" @input="handleAmountInput">
              </div>
            </div>
          </div>
...
const fetchTransaction = async () => {
  try {
    ...
    router.push('/clients/transactions/due-receive');
  }
};
