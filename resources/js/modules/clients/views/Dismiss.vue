  ...
  <div class="content-card">
    <div class="content-header">
      <div class="d-flex justify-content-between align-items-center w-100">
        <h3 class="fs-5 m-0 text-light">Dismiss Due Invoices</h3>
      ...
      <div class="row mt-4">
        ...
        <div class="col-md-6">
          ...
          <div class="row g-0 mb-3 align-items-center">
            <label class="col-sm-3 col-form-label text-light fw-bold text-end pe-2">Total Selected</label>
            <div class="col-sm-9">
          ...
          <div class="row g-0 mb-3 align-items-center">
            <label class="col-sm-3 col-form-label text-light text-end pe-2">Dismiss Date</label>
            <div class="col-sm-9">
              <div class="input-group">
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <button class="btn btn-primary w-100 py-2 fw-bold" @click="submitPayment" :disabled="submitting || paymentForm.amount <= 0">
                ...
                <i v-else class="bi bi-check-circle me-1"></i> Confirm Dismiss
              </button>
            </div>
          </div>
        </div>
...
const handleAmountInput = () => {
  ...
  if (val > grandTotalDue.value) {
    ...
    toggleAll();
    Swal.fire({ toast: true, position: 'top-end', icon: 'warning', title: `Maximum dismiss amount is ${grandTotalDue.value}`, showConfirmButton: false, timer: 3000 });
  }
};
...
const submitPayment = async () => {
  ...
  try {
    await axios.post(`/api/clients/${clientId}/dismiss-invoices`, {
    ...
    Swal.fire({ toast: true, position: 'top-end', icon: 'success', title: 'Invoices dismissed successfully!', showConfirmButton: false, timer: 2000 });
    router.push('/clients');
  } catch (error) {
